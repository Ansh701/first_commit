...
export function AuthShell({
  ...
  return (
    <main className={`auth-experience ${className ?? ""}`} id="main-content">
      ...
      <section className="auth-context" aria-label="INSIPS trust workflow">
        ...
        <div className="auth-context-copy">
          ...
          <p>
            INSIPS connects source context, human confirmation, and independent
            review in one accountable workspace.
          </p>
        </div>
        <div className="auth-ledger" aria-hidden="true">
          <div>
            ...
            <small>Restricted to the right workspace</small>
          </div>
          <div>
            <span>
              <FileSearch size={16} />
            ...
            <small>Page-aware, candidate-ready</small>
          </div>
          <div>
            <span>
              <BadgeCheck size={16} />
            </span>
            <strong>Approved projection</strong>
            <small>Specific, dated, explained</small>
          </div>
        </div>
        <p className="auth-context-foot">
          Use synthetic demo access if you are exploring the product.
        </p>
      </section>

        ...
        <div className={`${styles.page} public-page`}>
          ...
          <form className="discovery-toolbar" action="/discover" method="get">
            <label className="search-field">
              ...
              <input
                defaultValue={query}
                name="q"
                placeholder="Search by organization, location, or cause"
              />
            </label>
            <label className="filter-select">
              <span className="sr-only">Filter by focus area</span>
              <select defaultValue={area} name="area">
          ...
          {organizations.length ? (
            ...
            <StatePanel
              ...
              description="Try a different organization name, location, or focus area."
              kind="empty"

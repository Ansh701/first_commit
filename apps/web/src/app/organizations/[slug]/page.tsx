        ...
        <main className="public-page" id="main-content">
          ...
          <section className="profile-hero">
            ...
            <aside className="profile-trust-summary">
              ...
              <p>
                Each indicator has its own meaning and review date. This is not
                a general guarantee.
              </p>
            </aside>
          </section>
          ...
          <div className="public-profile-grid">
                ...
                <div className="panel empty-state">
                  <div>
                    ...
                    <p>
                      ...
                      approved trust claims. That is different from being
                      rejected or untrustworthy.
                    </p>
                  </div>
                </div>
              )}
            ...
            <aside className="panel trust-explainer">
              <div className="panel-body">
                ...
                <p>
                  INSIPS shows evidence-backed review events. It does not
                  certify future conduct, provide legal advice, or convert
                  multiple statuses into a single trust score.
                </p>
                <ul>
